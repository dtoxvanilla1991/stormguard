      ...
      <Block>
        <List inset dividers>
          <ListItem className="detail-item">
            <span>Condition</span>
            <span>{forecast?.getWeather().main}</span>
          </ListItem>
          <ListItem className="detail-item">
            <span>High</span>
            <span>{forecast?.getTemperatureWithSymbol("max")}</span>
          </ListItem>
          <ListItem className="detail-item">
            <span>Low</span>
            <span>{forecast?.getTemperatureWithSymbol("min")}</span>
          </ListItem>
          <ListItem className="detail-item">
            <span>Humidity</span>
            <span>{forecast?.getHumidity()}%</span>
          </ListItem>
          <ListItem className="detail-item">
            <span>Wind</span>
            <span>{forecast?.getWindSpeed()}m/s</span>
          </ListItem>
        </List>
      </Block>
    </>
